<template>
    <FormAuth @submitForm="submitForm" title="Регистрация">
        ...
        <InputForm>            
                <input class='input' v-model.trim="formData.email" type="email" placeholder="Email">
                ...
                <div v-else-if="submitted && !$v.formData.email.maxLength" class="error">
                    Максимальное количество символов не должно превышать 64
                </div>            
        </InputForm>       
                
        <InputForm>            
                <input class='input' v-model="formData.username" type="text" placeholder="Username">

                <div v-if="submitted && !$v.formData.username.required" class="error">
                    Поле обязательно к заполнению
                </div>          
                ...
                <div v-else-if="submitted && !$v.formData.username.maxLength" class="error">
        ...
        <InputForm>            
                ...
                <div v-if="submitted && !$v.formData.password.required" class="error">
                    Поле обязательно к заполнению
                </div>

                <div v-else-if="submitted && !$v.formData.password.maxLength" class="error">
        ...
        <InputForm>                  
            <input class='input' v-model="formData.confirmPassword" type="password" placeholder="Сonfirm">

            <div v-if="submitted && !$v.formData.confirmPassword.sameAsPassword" class="error">
                Пароли не совпадают
            </div>            
        </InputForm>
