            ...
            <div class="col-lg-9 col-md-9">
                <div class="row align-items-center game-widget__content">
                    ...
                    <div class="col-lg-8 col-md-9">
                        <GameWidget :title="$t('game.tableShulte')">
                            <template v-slot:rules>
                                <p class="game-widget__block__text">
                                    Нажимайте на числа по их возрастанию, в
                                    зависимости от уровня количество ячеек будет
                                    увиличиваться. Ошибкой будет нажатие цифры
                                    которая не стоит следующей в очереди.
                                    Правильные нажатия помечаются - зеленым
                                    цветом, а ложные - красным. Будьте
                                    внимательны и старайтесь концентрировать
                                    взгляд на центре таблицы.
                                </p>
                            </template>
                        </GameWidget>
                    </div>
